...
| Citation panel (measurement programme) | [`citation-panel-2026-09-24.md`](citation-panel-2026-09-24.md): the fixed questions (verbatim), the account and engine conditions, what counts as a hit, the `declined` state, the subject and external controls, and the thresholds, published on 2026-09-24 **before the first round** so they cannot move with the data. Rounds are recorded in [`CHANGELOG.md`](../CHANGELOG.md) as dated tables. |

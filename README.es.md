...
| [`operations/`](operations/) | Stack, pasos de despliegue, los invariantes que bloquean un despliegue, el historial de decisiones y qué puede verificar un cliente desde fuera. Escrito por el lado de operaciones y traducido al inglés el 23-09-2026; sin máquinas, rutas, usuarios ni proveedores. |

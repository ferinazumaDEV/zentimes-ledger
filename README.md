...
| [`operations/`](operations/) | Stack, deployment steps, the invariants that block a deploy, the decision history and what a client can verify from outside. Written by the operations side, translated into English on 2026-09-23; no machines, paths, users or providers. |
